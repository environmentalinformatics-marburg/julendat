"""Move Linden logger data to level 0 folder structure (DFG-Exploratories).
...
import os
import gc
from julendat.processtools.stations.vpfstations.VPFStationToLevel0000 import \
    VPFStationToLevel0000
...
def main():
    ...
    for dataset in station_dataset:
        ...
        VPFStationToLevel0000(input_filepath=toplevel_processing_logger_path + 
