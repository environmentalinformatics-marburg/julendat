"""Process data from level 0250 to concatenated files of level 0290.
...
import os
import shutil
from julendat.processtools.products.StationToLevel0290 import \
    StationToLevel0290
...
def main():
    ...
    station_folders=locate_path("qc25_fah01_0290", input_path)
