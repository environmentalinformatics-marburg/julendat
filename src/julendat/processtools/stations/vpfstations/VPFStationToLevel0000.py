"""Move downloaded VPF logger data to level 0 folder structure.
...
import os
import shutil
from julendat.filetools.stations.vpfstations.VPFStationDataFile import \
    VPFStationDataFile
...
class VPFStationToLevel0000:   
    """Instance for moving downloaded VPF logger data to level 0 folders.
    """

    def __init__(self, input_filepath, config_file,run_mode="auto"):
        """Inits VPFStationToLevel0000.
    ...
    def init_StationFile(self, input_filepath):
        """Initializes VPF station data file.

        Args:
            input_filepath: Full path and name of the level 0 file
        """
        #try:
        self.logger_file = VPFStationDataFile(\
    ...
    def auto_configure(self):
        ...
        self.inventory = StationInventory(filepath=self.station_inventory, \
            ...
            serial_number=self.logger_file.get_serial_number())
